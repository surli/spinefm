...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>User Valid Configuration</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link fr.unice.spinefm.ActionModel.UserActionModel.impl.UserValidConfigurationImpl#getDomainElementName <em>Domain Element Name</em>}</li>
 *   <li>{@link fr.unice.spinefm.ActionModel.UserActionModel.impl.UserValidConfigurationImpl#getContextID <em>Context ID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class UserValidConfigurationImpl extends UserActionImplDelegate implements UserValidConfiguration
{
	/**
	 ...
	 * @generated
	 */
	protected UserValidConfigurationImpl()
	{
		super();
	}
	...
	{
		return UserActionModelPackage.Literals.USER_VALID_CONFIGURATION;
	}
	...
	public void setDomainElementName(String newDomainElementName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UserActionModelPackage.USER_VALID_CONFIGURATION__DOMAIN_ELEMENT_NAME, oldDomainElementName, domainElementName));
	}
	...
	public void setContextID(String newContextID)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UserActionModelPackage.USER_VALID_CONFIGURATION__CONTEXT_ID, oldContextID, contextID));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case UserActionModelPackage.USER_VALID_CONFIGURATION__DOMAIN_ELEMENT_NAME:
				return getDomainElementName();
			case UserActionModelPackage.USER_VALID_CONFIGURATION__CONTEXT_ID:
				return getContextID();
		}
