...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>User Deselect</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link fr.unice.spinefm.ActionModel.UserActionModel.impl.UserDeselectImpl#getDomainElementName <em>Domain Element Name</em>}</li>
 *   <li>{@link fr.unice.spinefm.ActionModel.UserActionModel.impl.UserDeselectImpl#getContextID <em>Context ID</em>}</li>
 *   <li>{@link fr.unice.spinefm.ActionModel.UserActionModel.impl.UserDeselectImpl#getFeatureName <em>Feature Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class UserDeselectImpl extends UserActionImplDelegate implements UserDeselect
{
	/**
	...
	{
		return UserActionModelPackage.Literals.USER_DESELECT;
	}
	...
	public void setDomainElementName(String newDomainElementName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UserActionModelPackage.USER_DESELECT__DOMAIN_ELEMENT_NAME, oldDomainElementName, domainElementName));
	}
	...
	public void setContextID(String newContextID)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UserActionModelPackage.USER_DESELECT__CONTEXT_ID, oldContextID, contextID));
	}
	...
	public void setFeatureName(String newFeatureName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UserActionModelPackage.USER_DESELECT__FEATURE_NAME, oldFeatureName, featureName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case UserActionModelPackage.USER_DESELECT__DOMAIN_ELEMENT_NAME:
				return getDomainElementName();
			case UserActionModelPackage.USER_DESELECT__CONTEXT_ID:
				return getContextID();
			case UserActionModelPackage.USER_DESELECT__FEATURE_NAME:
