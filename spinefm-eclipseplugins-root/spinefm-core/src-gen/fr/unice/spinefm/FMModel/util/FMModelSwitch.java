 ...
 * @generated
 */
public class FMModelSwitch<T> extends Switch<T>
{
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			case FMModelPackage.FEATURE_MODEL:
			{
			...
			case FMModelPackage.CONSTRAINT:
			{
